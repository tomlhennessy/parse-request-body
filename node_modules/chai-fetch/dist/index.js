...
module.exports = function chaiFetch(chai) {
    chai.Assertion.addMethod('responseText', function (expectedText) {
        return __awaiter(this, void 0, void 0, function () {
            var target, response, responseText, result, expectedMessage, notExpectedMessage;
    ...
    chai.Assertion.addMethod('status', function (expectedStatus) {
        return __awaiter(this, void 0, void 0, function () {
            var target, response, result, expectedMessage, notExpectedMessage;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        target = this._obj;
                    ...
                    case 1:
                        ...
                        expectedMessage = 'expected status to equal #{exp} but was #{act}';
                        notExpectedMessage = 'expected status not to equal #{exp} but was #{act}';
